...
#        // residual._keras_shape[DIM3_AXIS]
    stride_dim1 = round(input._keras_shape[DIM1_AXIS]/residual._keras_shape[DIM1_AXIS])
    stride_dim2 = round(input._keras_shape[DIM2_AXIS]/residual._keras_shape[DIM2_AXIS])
    stride_dim3 = round(input._keras_shape[DIM3_AXIS]/residual._keras_shape[DIM3_AXIS])  
...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        # first conv
        conv1 = _conv_bn_relu3D(filters=64, kernel_size=(6, 7, 7),
                                strides=(2, 2, 2),
